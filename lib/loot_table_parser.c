...
int init_loot_table(const char* loot_table_string, LootTableContext* context, const enum MCVersion version)
{
...
int init_loot_table_file(FILE* loot_table_file, LootTableContext* context, const enum MCVersion version)
{
